...
const config = {
  ...
  url: 'https://khai-izzat.github.io',
  ...
  organizationName: 'khai-izzat', // Usually your GitHub org/user name.
  projectName: 'centasaurus', // Usually your repo name.
  trailingSlash: false,
  onBrokenLinks: 'throw',
  ...
  // Add the docusaurus-plugin-remote-content plugin
  plugins: [
    [
